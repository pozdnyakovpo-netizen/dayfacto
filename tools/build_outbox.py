...
SKIP_PATTERNS = [
    "рабочая встреча", "рабочую встречу", "состоялась встреча",
    "абитуриент", "поступающ", "конкурсные списки", "академи",
    "наставничеств", "победител", "юбиле", "поздрав", "ветеран",
    "информирует о ситуации", "о ситуации в пунктах", "личный прием",
    "конкурс профессионального", "спартакиад", "соревнован",
